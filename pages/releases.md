...
Learn more about [types of Kotlin releases and their compatiblity](https://kotlinlang.org/docs/reference/evolution/kotlin-evolution.html#feature-releases-and-incremental-releases). 
    ...
    <tr>
        ...
        <td>
            ...
            <ul>
                ...
                <li><a href="https://kotlinlang.org/docs/reference/whatsnew14.html" target="_blank">What's new in Kotlin 1.4.0</a></li>
                <li><a href="https://kotlinlang.org/docs/reference/compatibility-guide-14.html" target="_blank">Compatibility Guide</a></li>
                <li><a href="https://kotlinlang.org/docs/reference/whatsnew14.html#migrating-to-kotlin-140" target="_blank">Migrating to Kotlin 1.4.0</a></li>
            </ul>
         </td>
        <td>
            <ul>
